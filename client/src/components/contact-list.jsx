                    ...
                    <div className="flex gap-5 items-center justify-start text-neutral-300">
                        {
                            ...
                            <Avatar className='h-10 w-10 rounded-full overflow-hidden'>
                                ...
                                : <div className={`${selectedChatData && selectedChatData._id === contact._id ? "bg-[#ffffff22] border border-white/70" : getColor(contact.color)} uppercase h-10 w-10 text-lg border-[1px] flex justify-center items-center rounded-full ${getColor(contact.color)}`}>
